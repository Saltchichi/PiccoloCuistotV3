      ...
      <div className="container position-sticky z-index-sticky top-0">
        <nav className="navbar navbar-expand-lg  blur blur-rounded top-0  z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div className="container">
            <div className="navbar-brand font-weight-bolder ms-sm-3"><Link to={{ pathname: `/` }}>Cooked</Link></div>
            ...
            <div className="collapse navbar-collapse" id="navigation">
              ...
              <ul className="navbar-nav">
                <li className="nav-item my-auto ms-3 ms-lg-0">
                  <div className="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1 mt-2 mt-md-0"><Link to={{ pathname: `/addRecipe` }} style={{ color: 'white' }}>
                    Ajouter une recette
                  </Link>
                  </div>
                </li>
